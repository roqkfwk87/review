...
# - 부동산 (시도, 시군구, 매매 평균, 보증금 평균, 월세 평균, 날짜, 수익률 평균 전체, 수익률 평균 40초과, 수익률 평균 40이하, 
# 매매가, 매매가격 대비 전세 비율 전체, 매매가격 대비 전세 비율 40초과, 매매가격 대비 전세 비율 40 이하, 전세가, 
# 전세가격 대비 월세 보증금 비율 전체, 전세가격 대비 월세 보증금 비율 40초과, 전세가격 대비 월세 보증금 비율 40이하)
...
# user_email : VARCHAR(100) NU UQ FK ()
# user_role :  VARCHAR(15) NU DEFAULT('ROLE_USER') CHECK('ROLE_USER', 'ROLE_ADMIN')
...
# contents : TEXT NN
# writer_id : VARCHAR(50) NN  FK user(iser_id)
